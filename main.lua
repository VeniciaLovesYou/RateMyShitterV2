...
local win = lib:Window("Rate My Shitter By Vince",Color3.fromRGB(44, 120, 224), Enum.KeyCode.RightControl)
...
gifs:Toggle("Animated Booth",false, function(t)
    ...
    while getgenv().animated do
        ...
        local args = {
            [1] = "Update",
            [2] = {
                ["DescriptionText"] = "This was made by Venicia and tresk",
                ["ImageId"] = 9533802715
            }
        }
